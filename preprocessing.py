...
def preprocess(data_dir: str,data_dir2: str):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir2', help='path to images and labels.')
    args = parser.parse_args()

    preprocess(data_dir=args.data_dir,data_dir2=args.data_dir2)